...
//
//  private final List<product> product = new ArrayList<product>();
//
//  public productservice() {
//    product.add(new product(1, "瑪利歐派對 超級巨星",
...
//    product.add(new product(2, "星之卡比 新星同盟",
...
//    product.add(new product(3, "集合啦！動物森友會",
